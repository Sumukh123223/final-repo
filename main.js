...
// CRITICAL: This log MUST appear if module loads - if you don't see this, module isn't executing
console.log('📦📦📦 main.js MODULE EXECUTING - This log proves the module is running!')
console.log('📦 Current URL:', window.location.href)
console.log('📦 Timestamp:', new Date().toISOString())

// Wrap everything in async IIFE to handle dynamic imports properly
